...
namespace CreateDll
{
    internal class Program
    {
        public static Type DynamicCreateType()
        {
            ...
            MethodBuilder mainMethodBuilder3 = tb.DefineMethod("VoidPtrToObject", MethodAttributes.Static | MethodAttributes.Public, CallingConventions.Standard,
            ...
            MethodBuilder mainMethodBuilder4 = tb.DefineMethod("ObjectToVoidPtr", MethodAttributes.Static | MethodAttributes.Public, CallingConventions.Standard,
            ...
            MethodBuilder mainMethodBuilderAs = tb.DefineMethod("AsPointer", MethodAttributes.Static | MethodAttributes.Public, CallingConventions.Standard);

            GenericTypeParameterBuilder[] gtps2 = mainMethodBuilderAs.DefineGenericParameters(new string[] { "T" });

            mainMethodBuilderAs.SetParameters(gtps2[0].MakeByRefType());
            mainMethodBuilderAs.SetReturnType(typeof(void*));

            ILGenerator ilGeneratorAs = mainMethodBuilderAs.GetILGenerator();
            ilGeneratorAs.Emit(OpCodes.Ldarg_0);
            ilGeneratorAs.Emit(OpCodes.Conv_U);
            ilGeneratorAs.Emit(OpCodes.Ret);
            mainMethodBuilderAs.DefineParameter(1, ParameterAttributes.None, "t");
