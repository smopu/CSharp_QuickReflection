...
namespace PtrReflection
{
    public unsafe class UnsafeOperation
    {
        ...
        public static bool IsCreate(Type type)
        {
            return true;
        }
        ...
        static object[] objs = new object[1];
        /// <summary>
        /// 获取引用类型的句柄
        /// </summary>
        /// <param name="tf"></param>
        /// <returns></returns>
        public unsafe static void** GetObjectHandle(object obj)
        {
            TypedReference d = __makeref(obj);
            //句柄
            void** handle = *(void***)(&d);

            //objs[0] = obj;
            //void** ptr = (void**)GeneralTool.ObjectToVoidPtr(objs[0]);
            //void* ptr2 = *ptr;
            //var obbb = GeneralTool.VoidPtrToObject(ptr2);
        ...
        public unsafe static int SizeOfHeap(Type type)
        {
        ...
        {
            var heapSize = UnsafeOperation.SizeOfHeap(type);
        ...
        public unsafe static int GetFieldOffset(IntPtr ptr)
        {
            ...
            return length + (chunkSize << 16) + PTR_COUNT;
        }
